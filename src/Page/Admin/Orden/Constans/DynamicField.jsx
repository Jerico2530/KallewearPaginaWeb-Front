...
export const DynamicField = ({ fieldKey, config, value, error, onChange, optionsData = {} }) => {
  ...
  if (fieldKey === "usuarioId") options = [{ value: "", label: "Seleccione..." }, ...(optionsData.usuarios || [])];
  if (fieldKey === "sucursalId") options = [{ value: "", label: "Seleccione..." }, ...(optionsData.sucursales || [])];
  if (fieldKey === "direccionId") options = [{ value: "", label: "Seleccione..." }, ...(optionsData.direcciones || [])];
