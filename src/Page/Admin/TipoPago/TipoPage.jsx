/**
 * Página de Administración de TipoPagos
 * ------------------------------------------------------------------
 * Propósito del componente:
 *   - Gestionar el CRUD de TipoPagos (crear, listar, editar, eliminar) dentro del panel administrativo.
...
export default TipoPagosPageAdmin;
